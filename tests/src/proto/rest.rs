...
pub mod rest_rpc_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_rpc(
        ...
        ) -> std::result::Result<tonic::Response<super::Get>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            req.extensions_mut().insert(GrpcMethod::new("rest.RestRPC", "GetRPC"));
        ...
        pub async fn get_query_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("rest.RestRPC", "GetQueryRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn post_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("rest.RestRPC", "PostRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn post_query_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("rest.RestRPC", "PostQueryRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn post_no_path_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rest.RestRPC", "PostNoPathRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn post_get_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("rest.RestRPC", "PostGetRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_response_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rest.RestRPC", "GetResponseRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn post_response_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rest.RestRPC", "PostResponseRPC"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn post_response_get_rpc(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rest.RestRPC", "PostResponseGetRPC"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod rest_rpc_server {
    ...
    #[async_trait]
    pub trait RestRpc: std::marker::Send + std::marker::Sync + 'static {
        async fn get_rpc(
            &self,
                ...
                "/rest.RestRPC/GetRPC" => {
                    ...
                    for GetRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RestRpc>::get_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/GetQueryRPC" => {
                    ...
                    for GetQueryRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::get_query_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/PostRPC" => {
                    ...
                    for PostRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::post_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/PostQueryRPC" => {
                    ...
                    for PostQueryRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::post_query_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/PostNoPathRPC" => {
                    ...
                    for PostNoPathRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::post_no_path_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/PostGetRPC" => {
                    ...
                    for PostGetRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::post_get_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/GetResponseRPC" => {
                    ...
                    for GetResponseRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::get_response_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/PostResponseRPC" => {
                    ...
                    for PostResponseRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::post_response_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rest.RestRPC/PostResponseGetRPC" => {
                    ...
                    for PostResponseGetRPCSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RestRpc>::post_response_get_rpc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RestRpcServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "rest.RestRPC";
    impl<T> tonic::server::NamedService for RestRpcServer<T> {
